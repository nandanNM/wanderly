...
function inviteHtml({
  ...
  // Table-based, inline-styled HTML for broad email-client support.
  return `<!doctype html>
<html>
      ...
      <tr><td align="center">
        <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="max-width:480px;width:100%;">
          ...
          <tr><td style="padding:16px 24px;font-size:12px;color:#9a9a9a;">
            This invite was sent by Wanderly. If you weren't expecting it, you can ignore this email.
          </td></tr>
        </table>
      </td></tr>
    </table>
...
/** Send a trip invite. Returns {sent:false} (no throw) when Resend isn't configured. */
export async function sendInviteEmail(
  to: string,
  opts: { inviterName: string; tripTitle: string; acceptUrl: string },
  ...
  try {
    await resend.emails.send({
      from,
      to,
      subject: `${opts.inviterName} invited you to “${opts.tripTitle}” on Wanderly`,
